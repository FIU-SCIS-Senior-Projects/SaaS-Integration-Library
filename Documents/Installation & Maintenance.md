...
After obtaining the repository navigate to /SaaS-Integration-Library/Code/Website/SaaS_Integration_Library and then run "pip install piprequirements.txt". You now have all the required libraries!
